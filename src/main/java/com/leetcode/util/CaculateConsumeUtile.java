...
/**
 * 计算编译器运行和编译所需要的时间的工具类
 */
public class CaculateConsumeUtile {
    public  long concurrentTime1, concurrentTime2, concurrentMemory1, concurrentMemory2;
    public List<String> runMsg = new ArrayList<>();
    ...
    public List<String> end() {
        ...
        String runTime = time.substring(0, time.equals("0.0") ? 1 : (time.indexOf(".") + 3)) + "ms";
        String useCpu = memory.substring(0, memory.equals("0.0") ? 1 : (memory.indexOf(".") + 3)) + "M";
